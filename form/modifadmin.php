...
$req = $pdo->fetch("SELECT COUNT(*) as x FROM admine WHERE identifiant='$identifiant'");
	if($req['x']!=1){
		header('location:modifadmin.php?error=1&message=l\'identifiant n\'existe pas');
		exit();
	}    
}
?>
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav  my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admine/connexionadmin.php">Connexion</a>
          </li>
          <?php } ?>
  ...
  if(isset($modif)){ ?>
 <!-- formulair de modification de mots de passe admin -->
      ...
      <div class=" ">
        ...
        <form action="../crud/addcrud.php" method="POST">
         ...
         <br>
          ...
          <input type="hidden" class="form-control" name="action" value="passwordadmin">  
